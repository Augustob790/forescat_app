                ...
                Container(
                  ...
                  child: Stack(children: [
                    widget.authStore.images != null
                        ? CircleAvatar(
                            radius: 64,
                            backgroundImage: MemoryImage(widget.authStore.images!),
                          )
                        : const CircleAvatar(
                            radius: 64,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: CustomButtonStandard(
                            onTap: () {
                              if (widget.authStore.signFormKey.currentState!.validate()) {
                                widget.authStore.registrar(widget.authStore.emailController.text, widget.authStore.passwordController.text, widget.authStore.images!, "");
                              }
                            },
